 ...
 *
 *	$Header: /home/guillaume/projects/soupcon/rrmerge/cvsdump/yabause/src/wii/wiiuse/wiiuse.h,v 1.1.2.1 2008-05-04 00:45:15 cyberwarriorx Exp $
 *
 */
...
typedef struct wiimote_t {
	WCONST int unid;						/**< user specified id						*/
		...
		WCONST struct bte_pcb *out_sock;	/**< output socket							*/
		WCONST struct bte_pcb *in_sock;		/**< input socket							*/
