...
typedef void (*opcodefunc)(SH2_struct *);
...
void bt(SH2_struct * sh) { // FIXME ya plus rapide
  long disp;
  long d = INSTRUCTION_CD(sh->instruction);
